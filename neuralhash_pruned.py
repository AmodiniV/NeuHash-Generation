...
class CustomActivation(nn.Module):
    ...
    def forward(self, x):
      ...
      relu_output = F.relu(x + 3)
      return relu_output / (relu_output + 1e-6)


class NeuralHash(nn.Module):
    onnx_path = '/content/drive/MyDrive/Adv_train_values/NeuralHash_pruned_batch.onnx'
    def __init__(self, tmp_model=onnx_path):
        super().__init__()
        self.layers = []
        #print("Current Working Directory:", os.getcwd())
        onnx_model = onnx.load(tmp_model)

        # Conv0
        self.conv0 = nn.Sequential(
            Conv2dDynamicSamePadding(
                3, 16, 3, 2, dilation=1, groups=1, bias=False),
            nn.BatchNorm2d(16, eps=9.999999974752427e-07,
        ...
        self.bottleneck2 = nn.Sequential(
            ...
            nn.BatchNorm2d(56, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(),
            Conv2dDynamicSamePadding(
            ...
            nn.BatchNorm2d(24, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True),
        )
        ...
        self.bottleneck3 = nn.Sequential(
            ...
            nn.BatchNorm2d(64, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(),
        ...
        self.bottleneck4 = nn.Sequential(
            Conv2dDynamicSamePadding(24, 72, kernel_size=(
                1, 1), stride=(1, 1), bias=False),
            nn.BatchNorm2d(72, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(),
        ...
        self.bottleneck4_2 = nn.Sequential(
            ...
            Conv2dDynamicSamePadding(72, 32, kernel_size=(
                1, 1), stride=(1, 1), bias=False),
            nn.BatchNorm2d(32, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True)
        )
        ...
        self.bottleneck5 = nn.Sequential(
            Conv2dDynamicSamePadding(32, 184, kernel_size=(
                1, 1), stride=(1, 1), bias=False),
            nn.BatchNorm2d(184, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(),
        ...
        self.bottleneck7 = nn.Sequential(
            Conv2dDynamicSamePadding(32, 88, kernel_size=(
                1, 1), stride=(1, 1), bias=False),
            nn.BatchNorm2d(88, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(),
        ...
        self.bottleneck7_2 = nn.Sequential(
            ...
            Conv2dDynamicSamePadding(88, 40, kernel_size=(
                1, 1), stride=(1, 1), bias=False),
            nn.BatchNorm2d(40, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True)
        )
        ...
        self.bottleneck8 = nn.Sequential(
            Conv2dDynamicSamePadding(40, 112, kernel_size=(
                1, 1), stride=(1, 1), bias=False),
            nn.BatchNorm2d(112, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(),
        ...
        self.bottleneck9 = nn.Sequential(
            Conv2dDynamicSamePadding(40, 216, kernel_size=(
                1, 1), stride=(1, 1), bias=False),
            nn.BatchNorm2d(216, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(),
        ...
        self.bottleneck10 = nn.Sequential(
            Conv2dDynamicSamePadding(72, 432, kernel_size=(
                1, 1), stride=(1, 1), bias=False),
            nn.BatchNorm2d(432, eps=9.999999974752427e-07,
                              momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(),
